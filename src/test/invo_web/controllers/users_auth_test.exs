defmodule InvoWeb.UsersAuthTest do
  use InvoWeb.ConnCase, async: true

  alias Invo.Accounts
  alias InvoWeb.UsersAuth
  import Invo.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, InvoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_users/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      InvoWeb.Endpoint.subscribe(live_socket_id)
